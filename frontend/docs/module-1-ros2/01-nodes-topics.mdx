...
<DiagramViewer
  ...
  alt="Diagram showing ROS2 Publisher-Subscriber Communication Pattern - Publishers send data to a named topic, and subscribers receive data from that topic."
/>
